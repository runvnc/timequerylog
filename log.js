      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt('return', streams[fname]);
          ...
          case 9:
            fexists = _context3.sent;
            encodeStream = null;
            fileStream = (0, _fs3.createWriteStream)(fname, { flags: 'a' });

            lastWriteTime[fname] = new Date();

            _context3.t0 = (0, _path.extname)(fname);
            _context3.next = _context3.t0 === '.msp' ? 16 : 18;
            break;
          ...
          case 20:
            ...
            lastAccessTime[fname] = new Date();
            return _context3.abrupt('return', encodeStream);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 18:
            ...
            console.error('Error in snappy compress:', _context4.t0);
            compressing[f] = false;
...
var compressOld = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(_ref6) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 37:
            ...
            compressing[type] = false;
            throw new Error('timequerylog problem compressing old files: ' + _context5.t1.message);
    ...
    }, _callee5, this, [[4, 37], [18, 22, 26, 34], [27,, 29, 33]]);
  }));
...
var whichFiles = exports.whichFiles = function () {
  var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(type, start, end) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 11:
            ...
            console.error('timequerylog error reading dirlist: ' + _context7.t0.message + ' cfg.path is ' + cfg.path);return _context7.abrupt('return', []);
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 11:
                      ...
                      console.error('Error filtering log files:' + _context6.t0.message);return _context6.abrupt('return', {
                        v: []
                      });
          ...
          case 29:
            ...
            return _context7.delegateYield(_loop(), 't1', 31);
    ...
    }, _callee6, this, [[5, 11], [26, 39, 43, 51], [44,, 46, 50]]);
  }));
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 11:
            ...
            delete last.time;
            delete last.type;
            return _context17.abrupt('return', last);
...
function matchRows(_ref8) {
  var data = _ref8.data,
      start = _ref8.start,
      end = _ref8.end,
      matchFunction = _ref8.matchFunction;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 3:
                ...
                return _context14.abrupt('return', _this2.data);
              ...
              case 32:
                ...
                console.error('filterfile err in loadfile', _context14.t0);
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 9:
              ...
              _this2.rowNum++;
              return _context15.abrupt('return', row);

            case 14:
              _context15.prev = 14;
              _context15.t0 = _context15['catch'](0);

              console.error('nextRow issue', _context15.t0);
